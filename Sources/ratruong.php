...
<?php
    ...
    $sql = "SELECT ct.TenCT,vl.TenVL,kv.TenKV,tt.Logo,tt.Luong,vl.TrangThai FROM khuvuc kv , congty ct, vieclam vl ,thongtin tt where tt.MaVL=vl.MaVL and vl.MaCT=ct.MaCT and ct.MaKV=kv.MaKV and vl.TrangThai='ratruong'";
                ...
                <div class="col-md-12 col-sm-12" id="box-salary-high-jobs">
                    <div class="box_general">
                        <h2 class="text_ellipsis uppercase">
                            ...
                            <a href="javascript:void(0)" title="" style="color: #fff"> VIỆC LÀM MỚI RA TRƯỜNG</a>
                        </h2>
