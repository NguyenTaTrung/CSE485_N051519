                ...
                <div class="col-md-12 col-sm-12" id="box-salary-high-jobs">
                    <div class="box_general">
                        <h2 class="text_ellipsis uppercase">
                            ...
                            <a href="javascript:void(0)" title="Việc làm lương cao" style="color: #fff"> VIỆC LÀM CẤP QUẢN LÝ</a>
                        </h2>
                                                                ...
                                                                <a href="job.php"
                                                                    ...
                                                                    <span>
                                                                        <strong data-toggle="tooltip" title="UI/UX Designer"
                                                                            ...
                                                                            style="font-weight: bold;">UI/UX Designer</strong><!--nganh nghe-->
                                                                    </span>
                                                                </a>
                                                            </div>
                                                            <div class="company text_ellipsis">
                                                                <a href="job.php"
                                                                    ...
                                                                    <span data-toggle="tooltip" title="C&ocirc;ng ty cổ phần MISA - Trung t&acirc;m Ph&aacute;t triển phần mềm"
                                                                        ...
                                                                        ty cổ phần MISA - Trung t&acirc;m Ph&aacute;t<!--công ty-->
                                                                        triển phần mềm</span>
                                                                </a>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="col-md-5 col-sm-6 col-job-info text-dark-gray">
                                                    <div class="row">
                                                        ...
                                                        <div title="H&agrave; Nội" class="address col-xs-6">
                                                            <i class="icons8-map-pin text-highlight"></i>H&agrave; Nội<!--khu vực-->
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
